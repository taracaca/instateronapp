...
import com.android.instateronapp.ui.utils.GlideUtil;
    ...
    */
        ...
        btnMoreSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (storage) {
                    ...
                    Toast.makeText(getContext(), "Permissão externa é nescessária", Toast.LENGTH_LONG).show();
                }
            }
        });
                    ...
                    if ((user.getUid().contentEquals(postUID)) || (user.getUid() == postUID)) {
                        try {
                            new android.support.v7.app.AlertDialog.Builder(getContext())
                                    ...
                                    .setMessage("Você deseja mesmo apagar este post?")
                                    ...
                                    .setPositiveButton("Deletar", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int whichButton) {
                                            ...
                                            Toast.makeText(getContext(), "Post deletado!", Toast.LENGTH_SHORT).show();
                                        }
                                    })
    ...
    private void DeletePosts(Map<String, Object> posts, String finalPostKey) {
        ...
        for (Map.Entry<String, Object> entry : posts.entrySet()) {
            ...
            Toast.makeText(getContext(), "Deletar " + finalPostKey, Toast.LENGTH_LONG).show();
            ...
            public void onComplete(Bitmap result) {
                ...
                BasicImageDownloader.writeToDisk(myImageFile, result, new BasicImageDownloader.OnBitmapSaveListener() {
                    ...
                    public void onBitmapSaved() {
                        Toast.makeText(getContext(), "Imagem salva: " + myImageFile.getAbsolutePath(), Toast.LENGTH_LONG).show();
                    }
        ...
        if (currentAPIVersion >= Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(context, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) context, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                    ...
                    alertBuilder.setTitle("Permission nescessária");
                    alertBuilder.setMessage("Permissão externa é nescessária");
