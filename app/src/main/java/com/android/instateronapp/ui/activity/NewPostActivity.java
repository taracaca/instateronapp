package com.android.instateronapp.ui.activity;
...
import com.android.instateronapp.R;
import com.android.instateronapp.camera.AlbumStorageDirFactory;
import com.android.instateronapp.camera.BaseAlbumDirFactory;
import com.android.instateronapp.camera.FroyoAlbumDirFactory;
import com.android.instateronapp.ui.utils.Utils;
...
public class NewPostActivity extends BaseActivity implements
            ...
            if (storageDir != null) {
                if (!storageDir.mkdirs()) {
                    if (!storageDir.exists()) {
                        Log.e("Novo post da camera", "Erro ao criar diretorio");
                        return null;
                    }
                }
            }
    ...
    private void handleBigCameraPhoto() {
        ...
        try {
            ...
            Toast.makeText(this, "Error ao setar nova imagem.", Toast.LENGTH_LONG).show();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gallery_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                userChoosenTask = "Escolher da biblioteca";
                if (result)
                    galleryIntent();
            }
        });
        ...
        mSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (!(isOnline() && isConnected())) {
                    Snackbar.make(findViewById(R.id.switcher), "Não é possivel postar imagem. Sem acesso a internet", Snackbar.LENGTH_LONG)
                    ...
                    try {
                        if (mResizedBitmap == null) {
                            Toast.makeText(NewPostActivity.this, "Descrição da imagem...",
        ...
        NewPostActivity.this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (activity != null && !activity.isFinishing()) {
                    ...
                    if (error == null) {
                        Toast.makeText(NewPostActivity.this, "Post criado", Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
    ...
    private void loadNewImage(String filePath) {
        Log.i(TAG, "Carregando imagem: " + filePath);
        ...
        if (currentAPIVersion >= android.os.Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(context, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                if (ActivityCompat.shouldShowRequestPermissionRationale((android.app.Activity) context, Manifest.permission.CAMERA)) {
                    ...
                    alertBuilder1.setTitle("Permissão da camera");
                    alertBuilder1.setMessage("Permissão da camera é nescessária");
        ...
        if (currentAPIVersion >= android.os.Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(context, android.Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                if (ActivityCompat.shouldShowRequestPermissionRationale((android.app.Activity) context, android.Manifest.permission.READ_EXTERNAL_STORAGE)) {
                    ...
                    alertBuilder.setTitle("Permissão nescessária");
                    alertBuilder.setMessage("Permissão para armazenar externamente é necessaria");
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (cam)
                        try {
                            ...
                            Toast.makeText(this, "Ocorreu um erro com a camera. Utilizar galeria para postar foto.", Toast.LENGTH_LONG).show();
                        }
                    else if (userChoosenTask.equals("Escolher da biblioteca"))
                        galleryIntent();
                } else {
                    //code for deny
                }
    ...
    private void galleryIntent() {
        ...
        startActivityForResult(Intent.createChooser(intent, "Selecione o arquivo"), GALLERY);
    }
        ...
        if (bitmap != null) {
            ...
            try {
                ...
                */
                ...
                File directory = cw.getDir("instaterona", MODE_PRIVATE);
                // Create directory
                ...
                try {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(this, "Error ao salvar Bitmap" + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(this, "Error ao carregar Bitmap" + e.getMessage(), Toast.LENGTH_LONG).show();
                }
