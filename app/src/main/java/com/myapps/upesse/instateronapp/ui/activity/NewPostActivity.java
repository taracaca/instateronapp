...
import com.myapps.upesse.instateronapp.camera.AlbumStorageDirFactory;
import com.myapps.upesse.instateronapp.camera.BaseAlbumDirFactory;
import com.myapps.upesse.instateronapp.camera.FroyoAlbumDirFactory;
        ...
        if (bitmap != null) {
            ...
            try {
                ...
                */
                ...
                File directory = cw.getDir("UPES-SPE-Fest-2017", MODE_PRIVATE);
                // Create directory
